...
This section introduces a lot of new concepts. Don't worry if it feels abstract - you don't need to understand it all to do the project. It will make sense when you try the tutorial.
...
If multiple managers and subordinates are present in a system, an AXI interconnect is used, which has manager and subordinate interfaces of its own. It makes it easier to integrate different IP blocks. You see this generated in [Step 3: Use Design Assistance to Run Connection Automation](/projects/led_control_gpio.md#step-3-use-design-assistance-to-run-connection-automation) labelled AXI SmartConnect.

![AXI SmartConnect](/images/led_control_gpio/led_control_block_design.png)
**Figure 2:** Complete block design here to show the AXI SmartConnect.
...
**Figure 8:** The AXI GPIO IP from the tutorial below shows how the concepts described above - AXI channels, manager/subordinate roles, and VALID/READY handshakes - come together.
...
**Figure 13:** Explicitly selecting FCLK_CLK0 in properties
