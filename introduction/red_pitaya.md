...
- **Low-Pass Filter (~50 MHz):**
    ...
    - If you sample at a rate ​$f\_s$, the maximum frequency you can capture without distortion is half of that: $f_\text{max} = \frac{f_s}{2}$. This half-frequency is called the Nyquist frequency. 
